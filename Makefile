CXX = g++
CXXFLAGS = -lX11 -L/usr/X11/lib -I/usr/X11/include -Wall -std=c++0x -pthread -MMD #-DDEBUG_ANIMATE -DDEBUG_VIEW -DDEBUG_GRAPHIC #-DDEBUG #-DDEBUG_BOARD #-DMATCH_TEST #-DDEBUG_VIEW
EXEC = ss5k
